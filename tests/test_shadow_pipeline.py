import os,unittest
import contract_gap_report,shadow_pipeline as p
class T(unittest.TestCase):
 ...
 def test_gap_report_is_diagnostic_and_outer_mode_stays_research_only(self):
  import contract_gap_report as g
  self.c['contractHash']=g._hash(self.c['records']);self.m['dataContract']={'contractHash':self.c['contractHash']};os.environ[contract_gap_report.FLAG]='true'
  o=p.run(self.c,self.m,decision_as_of='2026-02-01T00:00:00+08:00');self.assertEqual(o['mode'],'research_only');self.assertEqual(o['contractGapReport']['mode'],'research_only')
