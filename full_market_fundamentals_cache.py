...
50 companies x 6 datasets per hour it uses the first-stage free-data budget,
...
def main() -> None:
    ...
    selected = [code for code in sorted(universe) if code not in reviewed and code not in unavailable][: max(1, min(50, args.batch_size))]
